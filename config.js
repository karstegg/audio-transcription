...
const CONFIG = {
  ...
  fileProcessing: {
    ...
    supportedAudioFormats: ['audio/mp3', 'audio/wav', 'audio/mpeg', 'audio/ogg', 'audio/webm', 'audio/aac', 'audio/flac', 'audio/mp4'],
    supportedVideoFormats: ['video/mp4', 'video/webm', 'video/ogg', 'video/quicktime', 'video/x-msvideo', 'video/x-matroska', 'video/mpeg'],
  },
